    ...
    <div class="card">
      <div class="card__header">
        <div class="card__picture">
          ...
          <img :src="require('@/assets/img/tours/'+tour['imageCover'])" alt="Tour 1" class="card__picture-img"/></div>
      ...
      <div class="card__details">
        ...
        <div class="card__data">
          ...
          <span>{{ tour.startLocation.description }}</span></div>
        <div class="card__data">
          <svg class="card__icon">
            <use xlink:href="@/assets/img/icons.svg#icon-calendar"></use>
          </svg>
          <span>{{ tour['startDates'][0]|dateStyle }}</span></div>
        <div class="card__data">
          <svg class="card__icon">
            <use xlink:href="@/assets/img/icons.svg#icon-flag"></use>
          </svg>
          <span>{{ tour.locations.length }} stops</span></div>
        <div class="card__data">
          <svg class="card__icon">
            <use xlink:href="@/assets/img/icons.svg#icon-user"></use>
          </svg>
          <span>{{ tour['maxGroupSize'] }} people</span></div>
      </div>
      <div class="card__footer">
        ...
        <router-link :to="{name:'Tour',params:{tourId:tour._id}}" class="btn btn--green btn--small">
          Details
        </router-link>
      </div>
    </div>
